    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filter: '<div class="input-group" style="width:95%;"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text"></div>',
                            ...
                            if (this.query !== event.target.value) {
                                ...
                                $.each($('li', this.$ul), $.proxy(function(index, element) {
                                    ...
                                    if (value !== this.options.selectAllValue && text) {
                                       ...
                                       // I (Mintu) modified this line
                                       //alert(filterCandidate.toLowerCase().indexOf(this.query.toLowerCase()));
                                        if (this.options.enableCaseInsensitiveFiltering && filterCandidate.toLowerCase().indexOf(this.query.toLowerCase()) == 1 || this.options.enableCaseInsensitiveFiltering && filterCandidate.toLowerCase().indexOf(this.query.toLowerCase()) == 0) {
                                            showElement = true;
                                        }
                                        //This is original line
                                        //else if (filterCandidate.indexOf(this.query) > -1) {
                                        // I (Mintu) modified this line
                                        else if (filterCandidate.indexOf(this.query) ==1 || filterCandidate.indexOf(this.query) ==0) {
                                            showElement = true;
                                        }
