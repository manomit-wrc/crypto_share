                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade @if ($tran_details[0]['transaction_type'] == 2)active in @endif" id="input_trade_targets">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" name="tab2_target1" placeholder="Target 1" type="number" value="{{$tran_details[0]['target_1']}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Target 2</label>
                                    <div class="col-md-10">
                                        <input class="form-control" name="tab2_target2" placeholder="Target 2" type="number" value="{{$tran_details[0]['target_2']}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Target 3</label>
                                    <div class="col-md-10">
                                        <input class="form-control" name="tab2_target3" placeholder="Target 3" type="number" value="{{$tran_details[0]['target_3']}}">
                                    </div>
                                </div>
                            </div>
