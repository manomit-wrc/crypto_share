...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">Edit Existing Pricing</h1>
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="add_testimonial" method="POST" action="/update_pricing" class="form-horizontal">
                    {{ csrf_field() }}
                    <input type="hidden" name="pricing_id" value="{{$pricing->id}}">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Pricing Title</label>
                        <div class="col-md-10">
                            <input class="form-control" name="pricing_title" placeholder="Pricing Title" type="text" value="{{ $pricing->pricing_title }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="pricing_amount" placeholder="Pricing Amount" type="text" value="{{ $pricing->pricing_amount }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="storage" placeholder="Storage" type="text" value="{{ $pricing->storage }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="no_of_clients" placeholder="No. of Clients" type="text" value="{{ $pricing->no_of_clients }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="active_projects" placeholder="Active Projects" type="text" value="{{ $pricing->active_projects }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="colors" placeholder="Colors" type="text" value="{{ $pricing->colors }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="goodies" placeholder="Goodies" type="text" value="{{ $pricing->goodies }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="email_support" placeholder="Email Support" type="text" value="{{ $pricing->email_support }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="status">
                                ...
                                <option value="1" @if($pricing->status == '1') selected @endif>Active</option>
                                <option value="0" @if($pricing->status == '0') selected @endif>In-Active</option>
                            </select>
                        </div>
