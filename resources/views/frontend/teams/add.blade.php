...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="frmTeams" method="POST" action="/teams" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-2 control-label">First Name</label>
                        <div class="col-md-10">
                            <input class="form-control" name="first_name" id="first_name" placeholder="First Name" type="text" value="{{ old('first_name') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="last_name" id="last_name" placeholder="Last Name" type="text" value="{{ old('last_name') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="designation" id="designation" placeholder="Designation" type="text" value="{{ old('designation') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <img src="{{ url('upload/teams/default.png') }}" class="img-responsive img-team" height="100px" width="100px">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="facebook_url" id="facebook_url" placeholder="Facebook URL" type="text" value="{{ old('facebook_url') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="twitter_url" id="twitter_url" placeholder="Twitter URL" type="text" value="{{ old('twitter_url') }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="google_plus_url" id="google_plus_url" placeholder="Google Plus URL" type="text" value="{{ old('google_plus_url') }}">
                        </div>
