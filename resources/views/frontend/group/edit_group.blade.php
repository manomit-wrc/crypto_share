                    ...
                    <div class="panel-body panel-form">
                        ...
                        {{ csrf_field() }}
							...
							<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
								...
								<div class="col-md-6 col-sm-6">
									<textarea class="form-control" name="description" id="description" placeholder="Description" data-parsley-required="true">{{ $fetch_details['description'] }}</textarea>
							...
							<div class="form-group {{ $errors->has('activity_status') ? 'has-error' : '' }}">
								...
								<div class="col-md-6 col-sm-6">
									<input type="checkbox" name="activity_status" id="activity_status" value="1" @if($fetch_details['activity_status'] == 1) checked="" @endif>
