...
Route::group(['middleware' => ['crypto']], function() {
	...
	Route::get('/group/members/{group_id}', 'GroupController@group_members');
	...
	Route::get('/previous_transaction', 'TransactionController@previous_transaction');
	...
	Route::get('/transaction/remove/{id}', 'TransactionController@remove_transaction');
