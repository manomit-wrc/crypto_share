...
class PageController extends Controller
{
    ...
    public function profile_view () {
        $fetch_country = countries::where('id', Auth::guard('crypto')->user()->country_id)->get()->toArray();
        ...
        return view('frontend.profile')->with('fetch_country', $fetch_country)->with('fetch_all_group_name', $fetch_all_group1);
    }
    ...
    public function edit_profile_view () {
        ...
        return view('frontend.profile_edit')->with('fetch_all_countries', $fetch_all_countries)
